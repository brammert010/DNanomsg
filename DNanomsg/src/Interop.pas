...
type
  ...
  Tnn_socket =
    function (domain: Integer; protocol: Integer): Integer; cdecl;
  ...
  Tnn_connect =
    function (s: Integer; addr: PChar): Integer; cdecl;
  ...
  Tnn_send =
    function (s: Integer; const buf; len: Integer; flags: Integer): Integer; cdecl;
...
type
  TInterop = class
  private
    FnanomsgAddr: Cardinal;
    Fnn_socket: Tnn_socket;
    Fnn_connect: Tnn_connect;
    Fnn_bind: Tnn_bind;
    Fnn_send: Tnn_send;
  ...
  TNanomsgLibraryLoader = class
    class function Lookup(nanomsgAddr: Cardinal; name: String): Pointer;
  end;
...
begin
  ...
  Fnn_bind := TNanomsgLibraryLoader.Lookup(FnanomsgAddr, 'nn_bind');
  Fnn_send := TNanomsgLibraryLoader.Lookup(FnanomsgAddr, 'nn_send');
end;
...
{ TNanomsgLibraryLoader }

class function TNanomsgLibraryLoader.Lookup(nanomsgAddr: Cardinal;
  name: String): Pointer;
begin
  Result := GetProcAddress(nanomsgAddr, PChar(name));
end;
